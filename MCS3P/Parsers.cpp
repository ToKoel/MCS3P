...
StructureProperties StructureFileParser::parseStructureFile(std::string filename){
    std::ifstream inFile;
...
MeasurementSettings CommandLineParser::parseCommandline(std::string argv){
        ...
        if(std::regex_match(str, regex)){
            ...
            if(token == "measurement"){
                ...
                if (value == "brute_force"){
                    measurementSettings.dipoleInteractionHandling = DipoleInteractions::kBruteForce;
                }
                else if (value == "macrocell"){
                    measurementSettings.dipoleInteractionHandling = DipoleInteractions::kMacrocellMethod;
                }
                else {
                    measurementSettings.dipoleInteractionHandling = DipoleInteractions::kNoInteractions;
                }
            }
